...
@Entity
@Table(name = "expertsignin_table")
public class ExpertSignin {
    ...
    public ExpertSignin(String phone, String fullname, String email, String experience, String fieldofexpertise,
			String qualification, String languagesspoken, String certifications, String status) {
		super();
		this.phone = phone;
